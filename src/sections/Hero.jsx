...
const [bigShoeImg, setbigShoeImg] = useState(bigShoe1)
    ...
    return (
        ...
        flex xl:flex-row justify-center min-h-screen
        flex-col  gap-10 
        max-container 
       ">
            <div className="relative xl:w-2/5 flex items-start
            flex-col w-full max-xl:padding-x
            pt-28 justify-center">
                <p className="text-lg font-
                montserrat text-sky-600
                ...
                max-sm:leading-[82] font-bold">
                    ...
                    ">The New Arrival in</span>
                    <br />
                    <span className="text-sky-600  inline-block
                    mt-3">ShoeWorld</span>
    
                </h1>
                <p className="text-lg font-montserrat mb-14
         text-slate-500 mt-6 sm:max-w-sm">Discover stylish shoe arrivals,
